...
public class sqlParser extends Parser {
	...
	public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, STAR = 8, KW_BY = 9,
			KW_FULL = 10, KW_DESC = 11, KW_ORDER = 12, KW_INSERT = 13, KW_WHERE = 14, KW_AS = 15, KW_ROWNUM = 16,
			KW_GROUP = 17, KW_ASC = 18, KW_RIGHT = 19, KW_IN = 20, KW_NULL = 21, KW_IS = 22, KW_INTO = 23,
			KW_UNION = 24, KW_FROM = 25, KW_SELECT = 26, KW_JOIN = 27, KW_ON = 28, KW_LEFT = 29, KW_ALL = 30,
			KW_INNER = 31, KW_CASE = 32, KW_WHEN = 33, KW_THEN = 34, KW_ELSE = 35, KW_END = 36, KW_NOT = 37,
			KW_AND = 38, KW_OR = 39, SEMI = 40, LPAREN = 41, RPAREN = 42, PLUS = 43, MINUS = 44, DIV = 45, MOD = 46,
			STRING = 47, INT = 48, DOUBLE = 49, EXPONENT = 50, IDENTIFIER = 51, WS = 52;
	public static final int RULE_prog = 0, RULE_dmlStatement = 1, RULE_insertStatement = 2, RULE_selectStatement = 3,
			...
			RULE_whereClause = 17, RULE_groupByClause = 18, RULE_orderByClause = 19, RULE_tableSource = 20,
			RULE_database = 21, RULE_alias = 22, RULE_tableName = 23, RULE_booleanExpression = 24,
			RULE_fieldExpression = 25, RULE_methodExpression = 26, RULE_caseExpression = 27, RULE_elseClause = 28,
	...
	public static final String[] ruleNames = { "prog", "dmlStatement", "insertStatement", "selectStatement",
			...
			"groupByClause", "orderByClause", "tableSource", "database", "alias", "tableName", "booleanExpression",
			"fieldExpression", "methodExpression", "caseExpression", "elseClause", "fieldName", "operator" };

	private static final String[] _LITERAL_NAMES = { null, "','", "'.'", "'='", "'>'", "'<>'", "'<'", "'!='", "'*'",
			null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
			null, null, null, null, null, null, null, null, null, null, null, null, null, "';'", "'('", "')'", "'+'",
			"'-'", "'/'", "'%'" };
	private static final String[] _SYMBOLIC_NAMES = { null, null, null, null, null, null, null, null, "STAR", "KW_BY",
			"KW_FULL", "KW_DESC", "KW_ORDER", "KW_INSERT", "KW_WHERE", "KW_AS", "KW_ROWNUM", "KW_GROUP", "KW_ASC",
			"KW_RIGHT", "KW_IN", "KW_NULL", "KW_IS", "KW_INTO", "KW_UNION", "KW_FROM", "KW_SELECT", "KW_JOIN", "KW_ON",
			"KW_LEFT", "KW_ALL", "KW_INNER", "KW_CASE", "KW_WHEN", "KW_THEN", "KW_ELSE", "KW_END", "KW_NOT", "KW_AND",
			"KW_OR", "SEMI", "LPAREN", "RPAREN", "PLUS", "MINUS", "DIV", "MOD", "STRING", "INT", "DOUBLE", "EXPONENT",
			"IDENTIFIER", "WS" };
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				if (!((((_la) & ~0x3f) == 0 && ((1L << _la)
						& ((1L << KW_FULL) | (1L << KW_RIGHT) | (1L << KW_LEFT) | (1L << KW_INNER))) != 0))) {
					_errHandler.recoverInline(this);
				} else {
					if (_input.LA(1) == Token.EOF)
						matchedEOF = true;
	...
	public static class BooleanExpressionContext extends ParserRuleContext {
		...
		public TerminalNode KW_AND() {
			return getToken(sqlParser.KW_AND, 0);
		}

		public TerminalNode KW_OR() {
			return getToken(sqlParser.KW_OR, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof sqlListener)
				((sqlListener) listener).enterBooleanExpression(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof sqlListener)
				((sqlListener) listener).exitBooleanExpression(this);
		}
	}
	...
	public static class FieldExpressionContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_fieldExpression;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof sqlListener)
				((sqlListener) listener).enterFieldExpression(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof sqlListener)
				((sqlListener) listener).exitFieldExpression(this);
		}
	}
					...
					if (_alt == 1) {
						...
						_prevctx = _localctx;
						{
							...
							case 1: {
								...
								_la = _input.LA(1);
								if (!((((_la) & ~0x3f) == 0
										&& ((1L << _la) & ((1L << STAR) | (1L << DIV) | (1L << MOD))) != 0))) {
									_errHandler.recoverInline(this);
								} else {
									if (_input.LA(1) == Token.EOF)
										matchedEOF = true;
	...
	public static class MethodExpressionContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof sqlListener)
				((sqlListener) listener).enterMethodExpression(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof sqlListener)
				((sqlListener) listener).exitMethodExpression(this);
		}
	}
	...
	public static class CaseExpressionContext extends ParserRuleContext {
		public TerminalNode KW_CASE() {
			return getToken(sqlParser.KW_CASE, 0);
		}

		public TerminalNode KW_END() {
			return getToken(sqlParser.KW_END, 0);
		}

		public List<TerminalNode> KW_WHEN() {
			return getTokens(sqlParser.KW_WHEN);
		}
		...
		public List<TerminalNode> KW_THEN() {
			return getTokens(sqlParser.KW_THEN);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof sqlListener)
				((sqlListener) listener).enterCaseExpression(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof sqlListener)
				((sqlListener) listener).exitCaseExpression(this);
		}
	}
	...
	public static class ElseClauseContext extends ParserRuleContext {
		public TerminalNode KW_ELSE() {
			return getToken(sqlParser.KW_ELSE, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_elseClause;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof sqlListener)
				((sqlListener) listener).enterElseClause(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof sqlListener)
				((sqlListener) listener).exitElseClause(this);
		}
	}
	...
	public static class FieldNameContext extends ParserRuleContext {
		...
		public TerminalNode DOUBLE() {
			return getToken(sqlParser.DOUBLE, 0);
		}
	...
	public static final String _serializedATN = "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\66\u0161\4\2\t\2"
